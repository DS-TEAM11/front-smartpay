	...
	<nav className="navbar navbar-expand-xl">
		<div className="container">
			...
			<a className="navbar-brand col-5 py-0" href="/">
				<img className="light-mode-item navbar-brand-item" src="assets/images/splogo2.png" alt="logo" style={{ width: '40%', height: 'auto' }}/>
			...
			<div className="navbar-collapse collapse " id="navbarCollapse">
				<ul className="navbar-nav navbar-nav-scroll dropdown-hover mx-auto">
					{/* <!-- Nav item --> */}
                    <li className="nav-item"> <a className="nav-link" href="/">메인 홈 </a> </li>
					<li className="nav-item"> <a className="nav-link" href="/history">결제 내역</a> </li>
					<li className="nav-item"> <a className="nav-link" href="/rank">이달의 카드 순위</a> </li>
